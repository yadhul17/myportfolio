      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="flex flex-col lg:flex-row gap-16 items-center lg:items-start">
          ...
          <div className="relative flex-shrink-0 group cursor-pointer">
            ...
            {/* Image Container */}
            <div className="relative w-full max-w-[300px] h-[400px] rounded-[1.8rem] overflow-hidden  border border-white/10 z-10 transition-transform duration-500 group-hover:scale-[0.98]">
              <img
                src={yadhul}
